...
const MusicList = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getMusic("https://mocki.io/v1/eed7c8f9-947c-4ff4-9701-95b34e8f4b01"));
  }, []);
  ...
  return (
    <>
      ...
      <div class="flex flex-wrap">
        ...
        <ul class="bg-white rounded-lg text-gray-900 w-full scroleList " style={{position:'sticky',top:'20rem',height:'50rem',overflowY:'scroll'}}>
