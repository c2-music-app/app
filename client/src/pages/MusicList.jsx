...
import { getFavoriteMusic, getTrendingMusic } from "../actions/musicActions";
    ...
    <>
      ...
      >
        ...
        <div className="mb-12 ms-6 space-y-5 md:mb-16 md:text-center">
          <h1 className="font-bebas-neue md:text-5xl text-left uppercase text-2xl lg:text-8xl font-black flex flex-col leading-none dark:text-white text-gray-800">
            Music can
            <span className="text-2xl lg:text-7xl md:text-5xl text-cyan-500">
              Bloom
            </span>
            Everywhere
          </h1>
