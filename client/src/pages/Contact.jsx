...
function Contact() {
  return (
    ...
    <div className="lg:flex">
        <div className="xl:w-2/5 lg:w-2/5 bg-[#02b875] py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
            <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                <h1 className="xl:text-4xl text-3xl pb-4 text-white font-bold">Get in touch</h1>
                <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">Got a question about us?</p>
        ...
        <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br">
                ...
                <div className="w-full mt-6">
                    ...
                    <button type="submit" className="focus:outline-none bg-[#02b875] transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6">
                        Submit
                    </button>
                </div>
            </form>
