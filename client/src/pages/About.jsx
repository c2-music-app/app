			...
			<div className="2xl:mx-auto 2xl:container 2xl:px-20 px-6 ">
				<div className="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
					<div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
						<div className="flex flex-col items-center justify-center">
							...
							<p className="sm:w-96 w-full mt-6 text-base leading-6 text-center text-gray-600">
								We are passionate about bringing you the best of the music
								world.
							</p>
							<div className="md:mt-14 mt-12 flex flex-col items-center">
								...
								<p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
									we believe that music is an art form that inspires, heals, and
							...
							<div className="mt-7 flex flex-col items-center">
								...
								<p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
									Community is important to us. That's why we provide a space
									for music enthusiasts to engage, share their thoughts, and
									foster connections.
								</p>
							</div>
							<div className="mt-7 flex flex-col items-center">
								...
								<p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
									Explore, discover, and immerse yourself in the captivating
									melodies that make life harmonious.
								</p>
							</div>
							<div className="mt-7 flex flex-col items-center">
								<div
								...
								<p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
									We prioritize delivering accurate information, promoting
									talented artists, and providing a user-friendly experience.
								</p>
							</div>
						</div>
					</div>
					<div className="py-12 xl:w-1/2 lg:w-1/3 sm:w-1/2">
						<img
							src="https://images.unsplash.com/photo-1506425113699-8c19d098e614?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80"
							alt="music"
